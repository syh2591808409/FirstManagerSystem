...
import com.first.project.common.utils.TimeConverter;
...
public class User implements Serializable {
    private static final long serialVersionUID = -4162209550443788326L;
    ...
    @Pattern(regexp = MOBILE_REG, message = "{mobile}")
