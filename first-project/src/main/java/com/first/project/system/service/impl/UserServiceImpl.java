...
import com.first.project.common.utils.MD5Util;
import com.first.project.common.utils.SortUtil;
import com.first.project.system.UserManager;
import com.first.project.system.dao.UserMapper;
...
import com.first.project.system.service.UserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public List<User> findByUserIds(String[] userIds) {
        ...
        for(String userid:userIds){
            userList.add(baseMapper.selectById(userid));
        }
        return userList;
    }
    ...
    public IPage<User> findUserDetail(User user, QueryRequest request) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "userId", FirstConstant.ORDER_ASC, false);
