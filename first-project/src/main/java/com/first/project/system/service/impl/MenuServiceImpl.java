...
import com.first.project.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    @Override
    public List<Menu> findByMenuIds(String[] menuIds) {
        List<Menu> menuList = new ArrayList<>();
        for(String menuid:menuIds){
            menuList.add(baseMapper.selectById(menuid));
        }
        return menuList;
    }
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), FirstConstant.TYPE_BUTTON)) {
