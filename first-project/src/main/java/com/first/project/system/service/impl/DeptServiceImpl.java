...
import com.first.project.common.domain.Tree;
import com.first.project.common.utils.SortUtil;
import com.first.project.common.utils.TreeUtil;
import com.first.project.system.dao.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    @Override
    public List<Dept> findByDeptIds(String[] deptIds) {
        List<Dept> deptList = new ArrayList<>();
        for(String deptid:deptIds){
            deptList.add(baseMapper.selectById(deptid));
        }
        return deptList;
    }
    ...
    public List<Dept> findDepts(Dept dept, QueryRequest request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", FirstConstant.ORDER_ASC, true);
