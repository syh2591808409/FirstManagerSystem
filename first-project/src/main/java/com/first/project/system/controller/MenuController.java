...
import com.first.project.common.domain.router.VueRouter;
...
public class MenuController extends BaseController {
    ...
    public void addMenu(@Valid Menu menu) throws FirstException {
        try {
    ...
    public void deleteMenus(@NotBlank(message = "{required}") @PathVariable String menuIds) throws FirstException {
        try {
    ...
    public void updateMenu(@Valid Menu menu) throws FirstException {
        try {
    ...
    @PostMapping("excel/{menuIds}")
    @RequiresPermissions("menu:export")
    public void export(@NotBlank(message = "{required}") @PathVariable String menuIds,HttpServletResponse response) throws FirstException {
        try {
            String[] ids = menuIds.split(StringPool.COMMA);
            List<Menu> menus = this.menuService.findByMenuIds(ids);
    ...
    @PostMapping("excel")
    @RequiresPermissions("menu:export")
    public void export(Menu menu, HttpServletResponse response) throws FirstException {
        try {
