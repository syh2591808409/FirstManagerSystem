...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws FirstException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws FirstException {
        try {
    ...
    public void updateRole(Role role) throws FirstException {
        try {
    ...
    @PostMapping("excel/{roleIds}")
    @RequiresPermissions("role:export")
    public void export(@NotBlank(message = "{required}") @PathVariable String roleIds,HttpServletResponse response) throws FirstException {
        try {
            String[] ids = roleIds.split(StringPool.COMMA);
            List<Role> roles = this.roleService.findByRoleIds(ids);
    ...
    @PostMapping("excel")
    @RequiresPermissions("role:export")
    public void export(QueryRequest queryRequest, Role role, HttpServletResponse response) throws FirstException {
        try {
