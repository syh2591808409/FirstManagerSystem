...
import com.first.project.common.utils.HttpContextUtil;
import com.first.project.common.utils.IPUtil;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        String encryptToken = FirstUtil.encryptToken(token);
        String encryptTokenInRedis = null;
        try {
            encryptTokenInRedis = redisService.get(FirstConstant.TOKEN_CACHE_PREFIX + encryptToken + "." + ip);
